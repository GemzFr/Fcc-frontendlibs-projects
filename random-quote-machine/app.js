const QUOTES = [
  {
    ...
    wiki: 'https://en.wikipedia.org/wiki/John_Petrucci',
    music: 'https://www.youtube.com/results?search_query=dream+theater',
  ...
  {
    author: "Kirk Hammet",
    wiki: 'https://en.wikipedia.org/wiki/Kirk_Hammett',
    music:'https://www.youtube.com/results?search_query=metallica',
  ...
  },
  {
    ...
    wiki:'https://en.wikipedia.org/wiki/Steven_Wilson',
    music:'https://www.youtube.com/results?search_query=porcupine+tree',
  ...
  {
    author: "Greg Graffin",
    wiki:'https://en.wikipedia.org/wiki/Greg_Graffin',
    music:'https://www.youtube.com/results?search_query=bad+religion',
  ...
  },
  {
    ...
    wiki:'https://en.wikipedia.org/wiki/Zack_de_la_Rocha',
    music:'https://www.youtube.com/results?search_query=rage+against+the+machine',
  ...
  },
  {
    ...
    wiki:'https://en.wikipedia.org/wiki/Jonathan_Davis',
    music:'https://www.youtube.com/results?search_query=korn',
  ...
  {
    author: "Nujabes",
    music:'https://www.youtube.com/results?search_query=nujabes',
    wiki:'https://en.wikipedia.org/wiki/Nujabes',
  ...
  {
    author: "Joe Acheson",
    wiki:'https://en.wikipedia.org/wiki/Hidden_Orchestra',
    music:'https://www.youtube.com/results?search_query=hidden+orchestra',
  ...
  },
  {
    ...
    wiki:'https://en.wikipedia.org/wiki/Gazpacho_(band)',
    music:'https://www.youtube.com/results?search_query=gazpacho+band',
...
function Biography(props) {
  ...
  return(
    <React.Fragment>
    <div>
      <a id='biography' href={props.quote.wiki} target='_blank' className='text-white'>
    ...
    <div>
    <a id='music' href={props.quote.music} target='_blank' className='text-white'>
